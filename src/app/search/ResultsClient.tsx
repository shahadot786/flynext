...
import { SessionTimer } from "@/features/results/components/SessionTimer";
...
export function ResultsClient({
  ...
  const totalTravellers = adults + childrenCount + kids + infants;
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] font-semibold text-blue-100 mt-1 leading-none">
              {formatHeaderDate(date)} · {totalTravellers} Traveller
              {totalTravellers !== 1 ? "s" : ""}
            </p>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl animate-scale-up text-center flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 leading-relaxed mb-6 font-semibold">
              Flight prices and availability are constantly changing. Please
              search again to get the latest flight updates.
            </p>
            <button
              type="button"
              onClick={() => {
